...
jest.mock("./utils/random-board", () => {
  ...
  board.set(3, 2, 1);
  board.set(4, 1, 1);
  board.addNeighbourConstraint(
    new TsngoNeighbourConstraint(0, 3, "equal", "row")
  );
  board.addNeighbourConstraint(
    new TsngoNeighbourConstraint(0, 4, "not-equal", "row")
  );
  board.addNeighbourConstraint(
    new TsngoNeighbourConstraint(1, 0, "equal", "col")
  );

  board.addNeighbourConstraint(
    new TsngoNeighbourConstraint(3, 5, "equal", "col")
  );
  board.addNeighbourConstraint(
    new TsngoNeighbourConstraint(5, 0, "equal", "row")
  );
  board.addNeighbourConstraint(
    new TsngoNeighbourConstraint(5, 1, "not-equal", "row")
  );
  return {
